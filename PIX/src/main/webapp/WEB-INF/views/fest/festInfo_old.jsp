...
<form action="nogo" method="POST" enctype="multipart/form-data">
	<div class="col-sm-12" style="text-align: center; color: #bdc3c7">
		<h1> <a href="main">강원 페스티발</a>  어드민 정보 화면 </h1>
	</div>
	<div class="col-sm-4">
	</div>
	...
	<c:forEach var="var" items="${info}" varStatus="status">
		<div class="panel panel-primary">
		  <div class="panel-heading">
    		<h3 class="panel-title">${var.fest_event_info_title } <span class="glyphicon glyphicon-remove-sign" aria-hidden="true"></h3>
		  </div>
		  <div class="panel-body">
		    ${var.fest_event_info_content }
		  </div>	
		  <div class="panel-footer"><span class="glyphicon glyphicon-info-sign" aria-hidden="true"></span> 분류 : ${var.fest_event_info_type }  
		  <span class="glyphicon glyphicon-time" aria-hidden="true"></span> 생성일 : ${var.fest_event_info_created_on }</div>
		</div>	
	</c:forEach>
