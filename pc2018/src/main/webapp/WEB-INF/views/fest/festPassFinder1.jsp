        ...
        <section id="blog-wrapper" class="section-padding">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-4">
	                    <form action="festPassFinderAction" method="POST" enctype="multipart/form-data">
		                    <div class="text-center">
		                    <span style="color:orange; font-size: 60px; " >비밀번호 찾기</span><br><br>
							...
							<br>
							<input type="submit" value="비번찾기" class="form-control">
						</form>
					</div>		
