 								...
 								<div class="row">
					   			...
					   			<div class="col-xs-6" style="padding:0px; position: relative;" id='${ele.ufo_gid }'>
									<div>
						   				...
						   				<img id="stamp_yes_${ele.ufo_gid }" class="img-responsive"  style="z-index: 2; position:absolute; display:none;" src="https://www.pc2018.ga/image/complete_medal2.png">
							   			...
							   			<img id="stamp_${ele.ufo_gid }" class="img-responsive img-blink" style="display:none; position:absolute;" src="https://www.pc2018.ga/image/mission_cam2.png" onclick="showSingleStamp('${ele.ufo_gid }')">
							   			<c:choose>
